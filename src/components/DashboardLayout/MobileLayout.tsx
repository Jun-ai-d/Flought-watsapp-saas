...
import { LayoutDashboard, MessageSquare, HelpCircle, FileText, Settings, CreditCard, LogOut, Shield, Megaphone, Users, Menu, X, MoreHorizontal, Zap, ShoppingBag, ShoppingCart, Globe } from 'lucide-react';
